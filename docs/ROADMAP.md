...
| Test suite | 170 tests across protocol, modes, threading, retention, attachments, sandbox, judge, db concurrency, export tracking, exporter, provenance, doc export, ollama adapter, openrouter adapter, settings API |
